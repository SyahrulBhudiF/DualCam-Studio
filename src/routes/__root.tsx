		...
		<html lang="en">
			...
			<body>
				...
				<a
					...
					className="fixed bottom-3 right-3 z-40 flex items-center gap-1.5 bg-background/50 px-2.5 py-1.5 text-xs text-muted-foreground opacity-80 backdrop-blur-sm transition-opacity hover:opacity-100"
				>
